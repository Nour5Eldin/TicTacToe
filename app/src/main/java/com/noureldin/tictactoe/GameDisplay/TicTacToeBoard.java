...
if (!winningLine){
    if (game.updateGameBoard(row,col)){
        ...
        //updating the player turn for the game
    ...
    public void setUpGame(Button playerAgain, Button home, TextView playerDisplay, String[] names){
        game.setPlayerAgainButton(playerAgain);
